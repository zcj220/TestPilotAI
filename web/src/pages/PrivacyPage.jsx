export default function PrivacyPage() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px', color: '#1a1a1a', lineHeight: 1.8 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>隐私政策</h1>
      <p style={{ color: '#666', marginBottom: 40 }}>最后更新：2025年3月</p>

      <p>温州芯造科技有限公司（xinzaoai.com）非常重视您的隐私。本政策说明我们如何收集、使用和保护您的信息。</p>
      ...
      <p>如有隐私相关疑问，请发邮件至：<a href="mailto:support@xinzaoai.com" style={{ color: '#0969da' }}>support@xinzaoai.com</a></p>
    </div>
  );
}
